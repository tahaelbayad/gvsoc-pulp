...
class SnitchDma(gvsoc.systree.Component):
    ...
    def __init__(self, parent: gvsoc.systree.Component, name: str,
        ...
        self.add_sources([
            'pulp/snitch_NeuroSoC/idma/snitch_dma.cpp',
            'pulp/snitch_NeuroSoC/idma/fe/idma_fe_xdma.cpp',
            'pulp/snitch_NeuroSoC/idma/me/idma_me_2d.cpp',
            'pulp/snitch_NeuroSoC/idma/be/idma_be.cpp',
            'pulp/snitch_NeuroSoC/idma/be/idma_be_axi.cpp',
            'pulp/snitch_NeuroSoC/idma/be/idma_be_tcdm.cpp',
            'pulp/snitch_NeuroSoC/idma/be/idma_be_fifo.cpp',
        ])
